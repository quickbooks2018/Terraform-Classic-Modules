...
#Note: 1. Create Target Group First
  ...
  launch-configuration-security-groups = "${module.cloudelligent-ec2-sg.ec2-sg-security-group}"
  ...
  target-group-arns = "arn:aws:elasticloadbalancing:eu-west-1:898668804275:targetgroup/cloudelligent-tg/bbc376dff9e0dd2f"
